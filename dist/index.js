(() => {
      ...
      (function(global, factory) {
        ...
        var gsap2, _coreInitted2, _clamp3, _win3, _doc3, _docEl, _body, _isTouch, _pointerType, ScrollTrigger2, _root, _normalizer, _eventTypes, _context2, _getGSAP = function _getGSAP2() {
          ...
          if (!_coreInitted2 && gsap2 && typeof document !== "undefined" && document.body) {
            ...
            _isTouch = Observer3.isTouch = _win3.matchMedia && _win3.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart" in _win3 || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? 2 : 0;
            _eventTypes = Observer3.eventTypes = ("ontouchstart" in _docEl ? "touchstart,touchmove,touchcancel,touchend" : !("onpointerdown" in _docEl) ? "mousedown,mousemove,mouseup,mouseup" : "pointerdown,pointermove,pointercancel,pointerup").split(",");
            setTimeout(function() {
              return _startup = 0;
            }, 500);
            _setScrollTrigger();
        ...
        var Observer3 = function() {
          function Observer4(vars) {
            this.init(vars);
          }
          var _proto = Observer4.prototype;
        ...
        Observer3.version = "3.12.7";
        Observer3.create = function(vars) {
          return new Observer3(vars);
        };
        Observer3.register = _initCore3;
        Observer3.getAll = function() {
          return _observers.slice();
        };
        Observer3.getById = function(id) {
          return _observers.filter(function(o) {
            return o.vars.id === id;
          })[0];
        };
        _getGSAP() && gsap2.registerPlugin(Observer3);
          ...
          ScrollTrigger3.enable = function enable() {
            ...
            if (gsap$1) {
              ...
              if (_body$1) {
                ...
                _refresh100vh();
                _rafBugFix();
                Observer3.register(gsap$1);
                ScrollTrigger3.isTouch = Observer3.isTouch;
                _fixIOSBug = Observer3.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent);
                _ignoreMobileResize = Observer3.isTouch === 1;
        ...
        var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
          ...
          if (direction === true) {
            ...
            target.style.touchAction = direction === true ? "auto" : direction ? "pan-" + direction + (Observer3.isTouch ? " pinch-zoom" : "") : "none";
          }
          ...
          var node = (event2.changedTouches ? event2.changedTouches[0] : event2).target, cache = node._gsap || gsap$1.core.getCache(node), time = _getTime$1(), cs;
          ...
          return Observer3.create({
            ...
            onEnable: function onEnable() {
              return inputs && _addListener$1(_doc$1, Observer3.eventTypes[0], _captureInputs, false, true);
            },
            onDisable: function onDisable() {
              return _removeListener$1(_doc$1, Observer3.eventTypes[0], _captureInputs, true);
            }
          });
          ...
          var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self2, maxY, target = _getTarget(vars.target) || _docEl$1, smoother = gsap$1.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale = 1, initialScale = (Observer3.isTouch && _win$1.visualViewport ? _win$1.visualViewport.scale * _win$1.visualViewport.width : _win$1.outerWidth) / _win$1.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction3(momentum) ? function() {
        ...
        ScrollTrigger$1.normalizeScroll = function(vars) {
          ...
          var normalizer = vars instanceof Observer3 ? vars : _getScrollNormalizer(vars);
  ...
  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/dist/Observer.js
  var require_Observer = __commonJS({
    "node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/dist/Observer.js"(exports, module) {
      init_live_reload();
      (function(global, factory) {
        typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.window = global.window || {}));
      })(exports, function(exports2) {
  ...
  var import_Observer = __toESM(require_Observer(), 1);
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    gsapWithCSS.registerPlugin(import_Observer.default);
    gsapWithCSS.registerPlugin(import_ScrollTrigger.default);
